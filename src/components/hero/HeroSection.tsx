      ...
      <div className="max-w-6xl w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6">
          ...
          <div className="h-10 sm:h-12 flex items-center justify-center lg:justify-start overflow-hidden">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="inline-flex items-center gap-2.5 px-3 py-1 rounded-xl bg-blue-500/10 dark:bg-cyan-500/10 border border-blue-500/20 dark:border-cyan-500/20 text-blue-700 dark:text-cyan-300 font-mono text-base sm:text-xl font-bold tracking-tight"
              >
                <Terminal className="w-4 h-4 text-cyan-500" />
                <span>{PROFILE_DATA.rotatingRoles[roleIndex]}</span>
              </motion.div>
            </AnimatePresence>
          </div>
          ...
          <motion.div
            ...
            className="flex flex-wrap gap-2 justify-center lg:justify-start text-xs font-mono text-slate-600 dark:text-slate-400 pt-1"
          >
          ...
          <motion.div
            ...
            className="flex flex-wrap items-center gap-4 justify-center lg:justify-start pt-2"
          >
            <GlowButton href="#omnidesk" variant="primary" size="lg" icon={<ArrowRight className="w-4 h-4" />}>
              Explore My Work
            </GlowButton>
