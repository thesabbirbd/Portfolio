...
export function MapsExplorerSection() {
  ...
  return (
    <section id="maps" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full overflow-hidden">
      ...
      <div className="rounded-3xl glass-emerald p-6 sm:p-10 border border-[var(--color-accent)]/25 shadow-xl relative overflow-hidden">
        {/* Subtle Ambient Glow */}
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            <div className="p-5 rounded-2xl glass-subtle border border-[var(--color-accent)]/20 space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-xs font-mono text-[var(--text-muted)]">GEOSPATIAL PLATFORM</span>
                <span className="text-xs font-bold text-[var(--color-accent)]">VERIFIED</span>
              </div>
              ...
              <div className="pt-2 flex flex-wrap gap-2">
                <span className="px-2.5 py-1 text-xs rounded-lg bg-[var(--color-accent)]/10 text-[var(--color-accent)] dark:text-[var(--color-accent)] font-mono">
                  Street View 360&deg;
                </span>
                <span className="px-2.5 py-1 text-xs rounded-lg bg-[var(--color-accent)]/10 text-[var(--color-accent)] dark:text-[var(--color-accent)] font-mono">
                  HQ Recognition
