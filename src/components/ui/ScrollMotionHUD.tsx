    ...
    <>
      ...
      {showHUD && (
        <motion.div
          ...
          className="fixed top-18 right-4 z-40 hidden lg:flex items-center gap-2 px-3 py-1.5 rounded-full glass-spatial border border-[var(--color-secondary)]/25 shadow-lg backdrop-blur-xl text-slate-800 dark:text-cyan-300 font-mono text-xs select-none"
        >
          ...
          <span className="font-bold text-[var(--color-secondary)] dark:text-[var(--color-secondary)] min-w-[28px] text-right">
            {percent}%
          </span>
